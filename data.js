...
window.UI = {
  zh: {
    navWork: "文章", navProof: "AI 分享", navTopics: "主题", navAbout: "关于",
    heroEyebrow: "AI 工具应用 / 内容创造 / 公开分享",
    heroLine1: "罗军｜AI 工具应用",
    heroGrad: "与内容创造",
    heroLede: "我是罗军（JimmyLuo）。这里展示我把 AI 编程、自动化工作流和内容表达，用到工作场景、公开分享和个人创作中的实践记录。",
    ctaRead: "查看 AI 分享", ctaSubscribe: "阅读已发布文章",
    statPieces: "篇实践", statReaders: "读者", statYears: "年创作",
    featTitle: "已发布文章", featDesc: "来自我的微信公众号内容",
    libTitle: "已发布文章", libDesc: "来自我的公开发布内容",
    readMore: "阅读", watch: "观看", viewSet: "查看图集",
    minRead: "分钟", photos: "张",
    aboutTitle: "关于罗军", 
    aboutP1: "我关注的是把 AI 变成工作里的实用工具，而不是只停留在聊天、概念和热点。我的实践集中在 AI 编程、自动化工作流、内容创作和公开分享。",
    aboutP2: "这个网站先展示能公开查看的素材：得到学习圈分享片段、学校老师 AI 提效分享照片、AI 实战落地活动记录，以及已发布的公众号文章。",
    topicsTitle: "我写什么",
    origin: "在原平台查看",
    ...
    footTag: "AI 工具应用与内容创造。记录公开分享、已发布文章和可公开展示的实践材料。",
    rights: "保留所有权利",
    by: "作者", published: "发布于",
  },
  en: {
    navWork: "Articles", navProof: "AI Sharing", navTopics: "Topics", navAbout: "About",
    heroEyebrow: "AI tools / Content creation / Public sharing",
    heroLine1: "Luo Jun: AI Tools",
    heroGrad: "and Content Creation",
    heroLede: "I'm Luo Jun (JimmyLuo). This site shows how I use AI coding, automation workflows, and content expression in real work, public sharing, and personal creation.",
    ctaRead: "View AI talk", ctaSubscribe: "Read articles",
    statPieces: "hands-on", statReaders: "readers", statYears: "yrs writing",
    featTitle: "Published Articles", featDesc: "Public pieces from my WeChat account",
    libTitle: "Published Articles", libDesc: "Publicly published content from my own channels",
    readMore: "Read", watch: "Watch", viewSet: "View set",
    minRead: "min", photos: "photos",
    aboutTitle: "About Luo Jun",
    aboutP1: "I focus on turning AI into practical tools for real work, not just talking about trends. My practice centers on AI coding, automation workflows, content creation, and public sharing.",
    aboutP2: "This site currently highlights public materials: a Dedao AI coding talk clip, school AI-efficiency sharing photos, AI practice records, and published WeChat articles.",
    ...
    currently: [
      ["Positioning", "AI tools and content creation"],
      ["Public talk", "AI coding workflow clip"],
      ["Scenario", "trade outreach and content workflows"],
      ["Content source", "only published pieces"],
      ["Based in", "Shenzhen · Nanshan"],
    ],
    footTag: "AI tools and content creation. Public talks, published articles, and public-facing practice materials.",
...
window.TOPICS = [
  { icon: "◇", zh: ["AI 工具应用", "把 AI 接进日常工作流程"], en: ["AI Tooling", "Bringing AI into real workflows"] },
  { icon: "◈", zh: ["内容创造", "文章、视频、分享材料的表达与发布"], en: ["Content Creation", "Articles, video, and public sharing"] },
  { icon: "△", zh: ["AI 编程", "用 AI 辅助编程做业务小工具"], en: ["AI Coding", "Using AI coding to build business tools"] },
];
...
window.PROOF = {
  ...
  zh: {
    ...
    intro: "这段约 62 秒的视频来自得到 AI 学习圈分享。我用外贸客户开发场景说明，如何借助 AI 编程把需求拆解、方案生成、代码编写和流程串联起来，形成可复用的自动化工作流。",
  ...
  en: {
    ...
    intro: "This 62-second clip comes from a Dedao AI learning-circle talk. I used an overseas customer-development scenario to show how AI coding can connect requirement breakdown, solution design, code generation, and workflow automation.",
